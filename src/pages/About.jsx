    ...
    <main className="pt-28">
      <section className="max-w-6xl mx-auto px-6 pt-12 pb-20">
        ...
        >
          ...
          <em className="italic text-indigo">Reliable</em> Digital Experiences
        </motion.h1>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-24 grid grid-cols-1 md:grid-cols-2 gap-20 items-start">
        ...
        <div className="flex flex-col gap-8">
          ...
          <motion.p {...fadeUp(0.2)} className="text-base text-muted leading-relaxed">
            I care deeply about{' '}
            <strong className="text-ink font-medium">usability, accessibility, and thoughtful interaction</strong>{' '}
            — especially in products people rely on every day.
          </motion.p>
          ...
          <motion.blockquote
            {...fadeUp(0.4)}
            className="border-l-2 border-indigo pl-6 py-2"
          >
