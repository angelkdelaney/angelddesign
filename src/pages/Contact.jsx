  ...
  return (
    <main className="pt-28">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-12 pb-16">
        ...
        >
          Designing resilient systems in complex moments.
        </motion.h1>
      </section>
        ...
        <div className="flex flex-col gap-10">
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-ink text-paper text-sm font-medium px-8 py-4 hover:bg-accent transition-colors duration-300 w-fit"
            >
              LinkedIn →
            </a>
          </motion.div>
